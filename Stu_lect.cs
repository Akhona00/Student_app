...
{
    public partial class Stu_lect : Form
    {
        public Stu_lect()
        {
            InitializeComponent();
        ...
        private void BindGrid()
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT STUDENT_NUMBER\r\nFROM HCESPT where ([USERNAME] = @USERNAME)", con);
        ...
        private void Stu_lect_Load(object sender, EventArgs e)
        {
